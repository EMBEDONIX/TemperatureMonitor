...
namespace SpPerfChart
{
    ...
    public partial class RunnigGraph : UserControl
    {
        ...
        private decimal currentMaxValue = 125;
        // Offset value for the scrolling grid
        private int gridScrollOffset = 0;
        // The current average value
        private decimal averageOfVisibleValues = 0;
        // The average of all values
        private decimal averageTotal = 0;
        // Border Style
        ...
        private Queue<GraphPoint> waitingValues = new Queue<GraphPoint>();
        // Style and Design
        private RunningGraphStyle perfChartStyle;
        ...
        public RunningGraphStyle PerfChartStyle {
        ...
        public void AddValue(GraphPoint graphPoint) {
            if (scaleMode == ScaleMode.Absolute && graphPoint.Value > 100M)
                throw new Exception(String.Format("Values greater then 100 not allowed in ScaleMode: Absolute ({0})", graphPoint.Value));
        ...
        private void DrawAverageLine(Graphics g) {
            ...
            int verticalPosition = CalcVerticalPosition(averageTotal);
            Color before = perfChartStyle.AvgLinePen.Pen.Color;
